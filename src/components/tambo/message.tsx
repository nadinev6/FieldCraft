...
import { Check, ChevronDown, ExternalLink, Eye, Loader2, X } from "lucide-react";
    ...
    return (
      <div
        ...
        className={cn(
          ...
          role === "assistant" && "font-normal", // Override font-medium for assistant messages
          role === "assistant" && "dark:border dark:border-[var(--message-border-dark)]",
          className,
        )}
