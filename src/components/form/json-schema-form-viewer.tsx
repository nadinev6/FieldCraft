...
const StarRatingWidget: React.FC<any> = (props) => {
  const { value = 0, onChange, schema, disabled, readonly } = props;
  const maxRating = schema.maximum || 5;
      ...
      {Array.from({ length: maxRating }, (_, index) => {
        ...
        return (
          <button
            key={starValue}
            type="button"
            className="p-1 hover:scale-110 transition-transform duration-150 focus:outline-none focus:ring-2 focus:ring-gray-500 rounded disabled:cursor-not-allowed"
